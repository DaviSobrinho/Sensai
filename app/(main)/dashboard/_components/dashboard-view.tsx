...
const DashboardView = ({ insights }: any) => {
    ...
    const { icon: MarketOutlookIcon, color: marketOutlookColor } = getMarketOutlookInfo(insights.marketOutlook)
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                <Card>
                    <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                        ...
                        <TrendingUp className={`h-4 w-4 ${marketOutlookColor} text-muted-foreground bg-transparent`} />
                    </CardHeader>
                    <CardContent>
                        <div className='text-2xl font-bold'>
                ...
                <Card>
                    <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                        ...
                        <BriefcaseIcon className={`h-4 w-4 ${marketOutlookColor} bg-transparent`} />
                    </CardHeader>
                    <CardContent>
                        <div className='text-2xl font-bold'>
                ...
                <Card>
                    <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                        ...
                        <BrainIcon className={`h-4 w-4 ${marketOutlookColor} text-muted-foreground bg-transparent`} />
                    </CardHeader>
                    <CardContent>
